...
public class CoTermNSPair {
	...
	public static class TokenizerMapper extends Mapper<Object, Text, Text, IntWritable> {
		...
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			...
			// combines pair of two words
			for(int i=0;i<termArray.size();i++){
				String term1 = termArray.get(i);			// word1
				for(int j=i+1;j<termArray.size();j++){
					String term2 = termArray.get(j);		// word2
					// concat two words as one pair
	...
	public static void main(String[] args) throws Exception {
		...
		job.setCombinerClass(NSPairReducer.class);		// combiner
